...
public struct OptionPremiumFunding: Sendable, Equatable {
    ...
    ///   - feeBps: the exchange's option fee in basis points of the underlying
    ///     notional, which in the settlement coin is the units traded.
    ...
    public init(
        ...
        feeBps: Double, feeCapPctOfPremium: Double, available: Double,
        ...
        self.fee = Swift.min(units * feeBps / 10_000, premium * feeCapPctOfPremium / 100)
